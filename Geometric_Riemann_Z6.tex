...
All numerical data, source code, and validation scripts are available at the GitHub repository:
\url{https://github.com/J-constant-math/-J-constant-Riemann-.git}
Related preprints:
\begin{itemize}
\item Geometric framework for Riemann zeros: \url{https://doi.org/10.5281/zenodo.19865046}
\end{itemize}
...
During the preparation of this work, the author used \textbf{Doubao}, \textbf{Kimi}, and \textbf{DeepSeek} as AI assistants for the following purposes: collaborative theoretical derivation, high-precision numerical validation, logical review, structural organization, and LaTeX typesetting assistance. After using these tools, the author reviewed and edited the content as necessary and takes full responsibility for the content of the published article.
...
\bibitem{riemann2026} P. Jie, ``Geometric Framework for Riemann Zeros Based on J-Constant,'' Zenodo, 2026. \url{https://doi.org/10.5281/zenodo.19865046}
